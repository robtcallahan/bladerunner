 ...
 *
 * $Id: ArrayTree.js 78143 2013-08-22 15:49:29Z rcallaha $
 * $Date: 2013-08-22 11:49:29 -0400 (Thu, 22 Aug 2013) $
 * $Author: rcallaha $
 * $Revision: 78143 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/bladerunner/trunk/js/ArrayTree.js $
 *
 *******************************************************************************
 */
...
BRunner.ArrayTree = Ext.extend(Ext.ux.tree.EditorGrid, {
    initComponent: function () {
        ...
        this.loader = new Ext.ux.tree.TreeGridLoader({
            dataUrl:         'php/get_array_tree.php',
            baseParams:      {
                dataType: 'treegrid',
                node:     'root'
            },
            ...
            items: [
                {
                    ...
                    menu: {
                        ...
                        items: [
                            {
                                text:    'Export WWNs',
                                tooltip: 'Export all arrays, hosts and WWNs',
                                iconCls: 'export',
                                handler: function () {
                ...
                {
                    xtype: 'tbtext',
                    text:  'Search for Arrays, Hosts, VMs or WWNs: '
                },
                {
                    xtype:          'combo',
                    id:             'arraySearch',
        ...
        // call parent
        BRunner.ArrayTree.superclass.initComponent.apply(this, arguments);
    },
