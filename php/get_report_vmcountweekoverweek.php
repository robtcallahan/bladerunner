...
use STS\HPSIM\HPSIMVMSnapshotAggregateTable;
use STS\HPSIM\HPSIMVMSnapshotAggregate;
...
try {
    ...
    $snapList      = $snapListTable->getAllByType('vm');

    $aggTable = new HPSIMVMSnapshotAggregateTable();
    $aggAll = array();
    $datesArray = array();
    for ($i=3; $i>=0; $i--) {
    ...
    $aggHash = array();
    /** @var HPSIMVMSnapshotAggregate $agg */
